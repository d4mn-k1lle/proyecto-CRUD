...
from main import main_registro
...
def main_login():
    ...
    boton1=tk.Button(frame_SurEste,text="Iniciar sesion",font=("Helvetica",15,"bold"),bg="#0B4EBD",bd=0,fg="#fafafa",width=80,height=1,command=lambda:registro())#cambiar################################################################
