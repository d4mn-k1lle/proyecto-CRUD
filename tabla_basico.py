...
def mostrar_menu(event):
    if is_admin:  # Solo mostrar el menú si es administrador
        context_menu.post(event.x_root, event.y_root)

# función para agregar un botón desde el menú contextual
def agregar_boton():
    if is_admin:  # Verificar permisos antes de ejecutar la acción
...
# Condicionales basados en permisos
if is_admin:
...
image_path = r"Proyecto Mati\login_intento-legible.8\imagenes\logo_escuela.png"
