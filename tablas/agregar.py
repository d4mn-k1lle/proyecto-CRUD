...
def obtener_lista_cursos():
    ...
    consulta = "SELECT DISTINCT curso FROM estudiantes;"
...
def crear_agregar(root, tree, lista_permitidos):
    ...
    def obtener_valores(var1, var2, var3, var4, var5, var6):
        ...
        if valor_1 in lista_permitidos:
            ...
            # Modificación: Recuperar los datos del estudiante si el DNI ya existe
            consulta = f"SELECT curso, nombres, apellidos, fecha_ingreso, dni, observaciones FROM estudiantes WHERE dni = {vare5};"
