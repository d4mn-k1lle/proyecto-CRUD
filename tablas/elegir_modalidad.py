...
def pantalla_principal():
    ...
    boton_basico=tk.Button(frame_botones,text="Basico",font=("Times",14,"bold"),width=15,height=2,bg="#fff",fg="#111",borderwidth=2,relief="flat",activebackground="#fff",activeforeground="#111", overrelief="solid",command=lambda: abrir_archivo(ventana,"tablas/tabla_basico.py"))
    boton_basico.place(relx=0.07,rely=0.20)

    #-- creamos el boton de MMO --#
    boton_MMO=tk.Button(frame_botones,text="MMO",font=("Times",14,"bold"),width=15,height=2,bg="#fff",fg="#111",borderwidth=2,relief="flat",activebackground="#fff",activeforeground="#111", overrelief="solid",command=lambda: abrir_archivo(ventana,"tablas/tabla_MMO.py"))
    boton_MMO.place(relx=0.39,rely=0.20)

    #-- creamos el boton de informatica --#
    boton_informatica=tk.Button(frame_botones,text="Informatica",font=("Times",14,"bold"),width=15,height=2,bg="#fff",fg="#111",borderwidth=2,relief="flat",activebackground="#fff",activeforeground="#111", overrelief="solid",command=lambda: abrir_archivo(ventana,"tablas/tabla_informatica.py"))
    boton_informatica.place(relx=0.07,rely=0.46)

    #-- creamos el boton de programacion --#
    boton_programacion=tk.Button(frame_botones,text="Programacion",font=("Times",14,"bold"),width=15,height=2,bg="#fff",fg="#111",borderwidth=2,relief="flat",activebackground="#fff",activeforeground="#111", overrelief="solid",command=lambda: abrir_archivo(ventana,"tablas/tabla_programacion.py"))
    boton_programacion.place(relx=0.39,rely=0.46)

    #-- creamos el boton de egresados --#
    boton_egresados=tk.Button(frame_botones,text="Egresados",font=("Times",14,"bold"),width=15,height=2,bg="#fff",fg="#111",borderwidth=2,relief="flat",activebackground="#fff",activeforeground="#111", overrelief="solid",command=lambda: abrir_archivo(ventana,"tablas/tabla_egresados.py"))
    boton_egresados.place(relx=0.07,rely=0.72)

    #-- creamos el boton de estudiantes con pase --#
    boton_e_pases=tk.Button(frame_botones,text="E.Pases",font=("Times",14,"bold"),width=15,height=2,bg="#fff",fg="#111",borderwidth=2,relief="flat",activebackground="#fff",activeforeground="#111", overrelief="solid",command=lambda: abrir_archivo(ventana,"tablas/tabla_e_pases.py"))
    ...
    integrante2=tk.Label(frame_integrantes,text="-Tiziano Cavallo",font=("Cambria",14,),bg="#B5BED6",fg="#1d1d1d")
    ...
    integrante4=tk.Label(frame_integrantes,text="-Aramis Lanas",font=("Cambria",14,),bg="#B5BED6",fg="#1d1d1d")
    integrante4.place(relx=0.08,rely=0.48)

    #-- creamos el label del quinto integrante --#
    integrante5=tk.Label(frame_integrantes,text="-Miranda Lopez",font=("Cambria",14,),bg="#B5BED6",fg="#1d1d1d")
    integrante5.place(relx=0.08,rely=0.55)

    #-- creamos el label del sexto integrante --#
    integrante6=tk.Label(frame_integrantes,text="-Marien Persico",font=("Cambria",14,),bg="#B5BED6",fg="#1d1d1d")
    integrante6.place(relx=0.08,rely=0.62)

    #-- creamos el label del septimo integrante --#
    integrante7=tk.Label(frame_integrantes,text="-Matias Cardozo",font=("Cambria",14,),bg="#B5BED6",fg="#1d1d1d")
    integrante7.place(relx=0.08,rely=0.69)

    #-- creamos el label del octavo integrante --#
    integrante8=tk.Label(frame_integrantes,text="-Gonzalo Cardozo",font=("Cambria",14,),bg="#B5BED6",fg="#1d1d1d")
