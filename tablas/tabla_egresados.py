...
def actualizar_combobox ():
    ...
    consulta =f"select Curso from egresados;"
...
def course_changed(event):
    ...
    DosEnUno(titulo_tabla,"Egresados " + curso_seleccionado,curso_seleccionado)
    # messagebox.showinfo("importante","curso seleccionado")
    print("curso seleccionado")

def tablita(conexion,curso):
    consulta=f"select * from egresados where curso='{curso}';"
...
boton_nuevo=tk.Button(frame_acciones,text="Agregar",bg="#4575F4",fg="#111",relief="flat",width=10,pady=0,font=("Cambria",14,"bold"),borderwidth=2, overrelief="solid",command=lambda:crear_agregar(ventana,arboledo,lista_verificacion,"egresados","opciones_btns_egresados"))#1751ED
boton_nuevo.place(relx=0.17,rely=0.5,anchor="center")

boton_modificar=tk.Button(frame_acciones,text="Modificar",bg="#4575F4",fg="#111",relief="flat",width=10,pady=0,font=("Cambria",14,"bold"),borderwidth=2, overrelief="solid",command=lambda:crear_modificar(ventana,arboledo,lista_verificacion,"egresados","opciones_btns_egresados"))
boton_modificar.place(relx=0.39,rely=0.5,anchor="center")

boton_eliminar=tk.Button(frame_acciones,text="Eliminar",bg="#4575F4",fg="#111",relief="flat",width=10,pady=0,font=("Cambria",14,"bold"),borderwidth=2, overrelief="solid",command=lambda:crear_eliminar(ventana,arboledo,"egresados","opciones_btns_egresados"))
