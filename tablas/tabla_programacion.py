...
def actualizar_combobox ():
    ...
    consulta =f"select Curso from programacion;"
...
def tablita(conexion,curso):
    consulta=f"select * from programacion where curso='{curso}';"
...
ventana=tk.Tk()
ventana.title("Tabla de Ciclo Superior Programacion")
...
titulo_tabla=tk.Label(frame_titulo_tabla,text="Ciclo Superior Programacion",bg="#fff",fg="#111",font=("Cambria",40,"bold"))
...
boton_nuevo=tk.Button(frame_acciones,text="Agregar",bg="#4575F4",fg="#111",relief="flat",width=10,pady=0,font=("Cambria",14,"bold"),borderwidth=2, overrelief="solid",command=lambda:crear_agregar(ventana,arboledo,lista_verificacion,"programacion","opciones_btns_programacion"))#1751ED
boton_nuevo.place(relx=0.17,rely=0.5,anchor="center")

boton_modificar=tk.Button(frame_acciones,text="Modificar",bg="#4575F4",fg="#111",relief="flat",width=10,pady=0,font=("Cambria",14,"bold"),borderwidth=2, overrelief="solid",command=lambda:crear_modificar(ventana,arboledo,lista_verificacion,"programacion","opciones_btns_programacion"))
boton_modificar.place(relx=0.39,rely=0.5,anchor="center")

boton_eliminar=tk.Button(frame_acciones,text="Eliminar",bg="#4575F4",fg="#111",relief="flat",width=10,pady=0,font=("Cambria",14,"bold"),borderwidth=2, overrelief="solid",command=lambda:crear_eliminar(ventana,arboledo,"programacion","opciones_btns_programacion"))
