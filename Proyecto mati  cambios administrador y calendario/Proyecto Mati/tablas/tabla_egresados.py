...
from observar import mostrar_informacion  # Importar la función
import tempfile
import os
...
def actualizar_combobox():
    ...
    consulta = "select Curso from egresados;"
...
boton_nuevo = tk.Button(frame_acciones, text="Agregar", bg="#4575F4", fg="#111", relief="flat", width=10, pady=0,
                        ...
                        command=lambda: crear_agregar(ventana, arboledo, lista_verificacion, "egresados", "opciones_btns_egresados"))
...
boton_modificar = tk.Button(frame_acciones, text="Modificar", bg="#4575F4", fg="#111", relief="flat", width=10, pady=0,
                            font=("Cambria", 14, "bold"), borderwidth=2, overrelief="solid",
                            command=lambda: crear_modificar(ventana, arboledo, lista_verificacion, "egresados", "opciones_btns_egresados"))
...
boton_eliminar = tk.Button(frame_acciones, text="Eliminar", bg="#4575F4", fg="#111", relief="flat", width=10, pady=0,
                           font=("Cambria", 14, "bold"), borderwidth=2, overrelief="solid",
                           command=lambda: crear_eliminar(ventana, arboledo, "egresados", "opciones_btns_egresados"))
...
boton_guardar = tk.Button(frame_acciones, text="Observar", bg="#4575F4", fg="#111", relief="flat", width=10, pady=0,
                          font=("Cambria", 14, "bold"), borderwidth=2, overrelief="solid",
                          command=lambda: mostrar_informacion(arboledo, ventana))  # Usar la función
