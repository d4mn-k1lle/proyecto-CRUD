...
class frames_imagenes:
    ...
    def abrir_archivo(self):
        ruta_archivo = "C:/Users/Net Bonzi/Desktop/tkinter/login_intento-legible.8/intento-registro4.py"
        try:
    ...
    def abrir_archivo_registro(self):
        ruta_archivo = "C:/Users/Net Bonzi/Desktop/tkinter/login_intento-legible.8/login-principal.py"
        try:
            subprocess.Popen(["python", ruta_archivo])
        except FileNotFoundError as e:
            messagebox.showerror("Error", f"No se pudo encontrar el archivo: {ruta_archivo}")
    ...
    def abrir_archivo_panelcontrol(self):
        ruta_archivo = "C:/Users/Net Bonzi/Desktop/tkinter/tablas/elegir_modalidad.py"
        try:
            subprocess.Popen(["python", ruta_archivo])
        except FileNotFoundError as e:
            messagebox.showerror("Error", f"No se pudo encontrar el archivo: {ruta_archivo}")
