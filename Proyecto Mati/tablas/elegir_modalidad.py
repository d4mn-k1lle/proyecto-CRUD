...
def pantalla_principal():
    ...
    subtitulo = tk.Label(frame_titulo, text="Escuela Tecnica Manuel Belgrano Nº1", bg="#3C5BBA", font=("Cambria", 14, "bold"), fg="#041C65")
    ...
    titulo_elegir = tk.Label(frame_botones, text="Por favor, seleccione una opción:", bg="#C6CFE9", font=("Book Antiqua", 22, "bold"), fg="#222")
    titulo_elegir.place(relx=0.04, rely=0.04)

    #-- Se crea el label del curso y año --#
    CursoProgramacion = tk.Label(ventana,
                                 text="5º3 Programación 2024",
                                 fg="#1d1d1d",
                                 bg="#B5BED6",
    ...
    boton_basico = tk.Button(frame_botones, text="Básico", font=("Times", 14, "bold"), width=15, height=2, bg="#fff", fg="#111",
                             ...
                             command=lambda: abrir_archivo(ventana, r"Proyecto mati  cambios administrador y calendario\Proyecto Mati\tablas\tabla_basico.py"))
    ...
    boton_MMO = tk.Button(frame_botones, text="MMO", font=("Times", 14, "bold"), width=15, height=2, bg="#fff", fg="#111",
                          borderwidth=2, relief="flat", activebackground="#fff", activeforeground="#111", overrelief="solid",
                          command=lambda: abrir_archivo(ventana, r"Proyecto mati  cambios administrador y calendario\Proyecto Mati\tablas\tabla_MMO.py"))
    ...
    boton_programacion = tk.Button(frame_botones, text="Programación", font=("Times", 14, "bold"), width=15, height=2, bg="#fff", fg="#111",
                                   borderwidth=2, relief="flat", activebackground="#fff", activeforeground="#111", overrelief="solid",
                                   command=lambda: abrir_archivo(ventana, r"Proyecto mati  cambios administrador y calendario\Proyecto Mati\tablas\tabla_programacion.py"))
    ...
    boton_egresados = tk.Button(frame_botones, text="Egresados", font=("Times", 14, "bold"), width=15, height=2, bg="#fff", fg="#111",
                                borderwidth=2, relief="flat", activebackground="#fff", activeforeground="#111", overrelief="solid",
                                command=lambda: abrir_archivo(ventana, r"Proyecto mati  cambios administrador y calendario\Proyecto Mati\tablas\tabla_egresados.py"))
    ...
    boton_e_pases = tk.Button(frame_botones, text="E.Pases", font=("Times", 14, "bold"), width=15, height=2, bg="#fff", fg="#111",
                              borderwidth=2, relief="flat", activebackground="#fff", activeforeground="#111", overrelief="solid",
                              command=lambda: abrir_archivo(ventana, r"Proyecto mati  cambios administrador y calendario\Proyecto Mati\tablas\tabla_e_pases.py"))
    ...
    nombres_integrantes = [
        "-Matias Gauto","-Matias Candia" "-Belenger Hernandez","-Tiziano Cavallo",  "-Aramis Lanas",
        "-Miranda Lopez", "-Marién Pérsico"
        "-Ian Aaron Celi"
    ]
